...
namespace Olbrasoft.Travel.Data.Entity.Framework.Repository
{
    ...
    public abstract class BaseRepository<T, TKey, TKey2> : SharpRepository.EfCoreRepository.EfCoreRepository<T, TKey, TKey2>, IBaseRepository<T, TKey, TKey2> where T : class
    {
    ...
    #endregion BaseRepository<T, TKey, TKey2>

    public class BaseRepository<T> : SharpRepository.EfCoreRepository.EfCoreRepository<T>, IBaseRepository<T> where T : class
    {
        public event EventHandler Saved;
