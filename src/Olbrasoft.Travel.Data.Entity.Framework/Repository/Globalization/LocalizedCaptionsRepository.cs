...
{
    public class LocalizedCaptionsRepository : LocalizedRepository<LocalizedCaption>, IOfLocalizedCaptions
    {
        ...
        public LocalizedCaptionsRepository(GlobalizationDatabaseContext context) : base(context)
        {
        }
    }
}