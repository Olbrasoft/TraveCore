...
{
    public class MappedPropertiesRepository<T> : PropertyRepository<T>, IMappedPropertiesRepository<T> where T : CreationInfo<int>, IHaveEanId<int>
    {
        ...
        public MappedPropertiesRepository(PropertyDatabaseContext context) : base(context)
        {
        }
