...
{
    public class PhotosOfAccommodationsRepository : PropertyRepository<PhotoOfAccommodation>, IPhotosOfAccommodationsRepository
    {
        public PhotosOfAccommodationsRepository(PropertyDatabaseContext context) : base(context)
        {
        }
