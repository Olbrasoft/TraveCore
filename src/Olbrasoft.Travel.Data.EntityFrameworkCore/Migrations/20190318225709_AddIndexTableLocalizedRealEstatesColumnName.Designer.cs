...
namespace Olbrasoft.Travel.Data.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20190318225709_AddIndexTableLocalizedRealEstatesColumnName")]
    partial class AddIndexTableLocalizedRealEstatesColumnName
    {
            ...
            modelBuilder.Entity("Olbrasoft.Travel.Data.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "df24b686-7b7d-4907-a042-0cc04c559345",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
